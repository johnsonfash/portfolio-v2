...
const Services = () => {
  return (
    <div className="mt-24 md:mt-20 pb-10">
      ...
      <div className="flex flex-wrap items-stretch justify-between">
        <div className="w-full lg:w-[48%] relative shadow-md rounded-sm min-h-full">
          <Image src='/process.jpeg' alt='' className="object-cover w-full h-full" width={1200} height={675} />
          <div className="absolute -bottom-9 -right-4 lg:-right-[3.5rem]">
            {
        ...
        <div className="w-full lg:w-[48%] mt-10 lg:mt-0 flex flex-wrap">
          <div className="w-full sm:w-[48%] px-4 py-8">
